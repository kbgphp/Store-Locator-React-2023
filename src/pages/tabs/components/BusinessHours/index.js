    ...
    <div>
      ...
      <div className='bussinesHoursInputs mt-4 mb-3'>
        ...
        <div className='row align-items-center mb-3'>
          ...
          <div className='col'>
            <SelectBox handleBusinessHoursChange={handleBusinessHoursChange} value={isChecked.monday} name='monday-open' disabled={checkvalidation.monday == false} />
          </div>
          <div className='col-auto'>To</div>
          <div className='col'>
            <SelectBox handleBusinessHoursChange={handleBusinessHoursChange} value={isChecked.monday} name='monday-close' disabled={checkvalidation.monday == false} />
          </div>
        </div>
        ...
        <div className='row align-items-center  mb-3'>
          ...
          <div className='col'>
            <SelectBox handleBusinessHoursChange={handleBusinessHoursChange} value={isChecked.tuesday} name='tuesday-open' disabled={checkvalidation.tuesday == false} />
          </div>
          <div className='col-auto'>To</div>
          <div className='col'>
            <SelectBox handleBusinessHoursChange={handleBusinessHoursChange} value={isChecked.tuesday} name='tuesday-close' disabled={checkvalidation.tuesday == false} />
          </div>
        </div>
        ...
        <div className='row align-items-center  mb-3'>
          ...
          <div className='col'>
            <SelectBox handleBusinessHoursChange={handleBusinessHoursChange} value={isChecked.wednesday} name='wednesday-open' disabled={checkvalidation.wednesday == false} />
          </div>
          <div className='col-auto'>To</div>
          <div className='col'>
            <SelectBox handleBusinessHoursChange={handleBusinessHoursChange} value={isChecked.wednesday} name='wednesday-close' disabled={checkvalidation.wednesday == false} />
          </div>
        </div>
        ...
        <div className='row align-items-center  mb-3'>
          ...
          <div className='col'>
            <SelectBox handleBusinessHoursChange={handleBusinessHoursChange} name='thursday-open' value={isChecked.thursday} disabled={checkvalidation.thursday == false} />
          </div>
          <div className='col-auto'>To</div>
          <div className='col'>
            <SelectBox handleBusinessHoursChange={handleBusinessHoursChange} name='thursday-close' value={isChecked.thursday} disabled={checkvalidation.thursday == false} />
          </div>
        </div>
        ...
        <div className='row align-items-center  mb-3'>
          ...
          <div className='col'>
            <SelectBox handleBusinessHoursChange={handleBusinessHoursChange} value={isChecked.friday} name='friday-open' disabled={checkvalidation.friday == false} />
          </div>
          <div className='col-auto'>To</div>
          <div className='col'>
            <SelectBox handleBusinessHoursChange={handleBusinessHoursChange} value={isChecked.friday} name='friday-close' disabled={checkvalidation.friday == false} />
          </div>
        </div>
        ...
        <div className='row align-items-center  mb-3'>
          ...
          <div className='col'>
            <SelectBox handleBusinessHoursChange={handleBusinessHoursChange} name='saturday-open' value={isChecked.saturday} disabled={checkvalidation.saturday == false} />
          </div>
          <div className='col-auto'>To</div>
          <div className='col'>
            <SelectBox handleBusinessHoursChange={handleBusinessHoursChange} name='saturday-close' value={isChecked.saturday} disabled={checkvalidation.saturday == false} />
          </div>
        </div>
        ...
        <div className='row align-items-center  mb-3'>
          ...
          <div className='col'>
            <SelectBox handleBusinessHoursChange={handleBusinessHoursChange} name='sunday-open' value={isChecked.sunday} disabled={checkvalidation.sunday == false} />
          </div>
          <div className='col-auto'>To</div>
          <div className='col'>
            <SelectBox handleBusinessHoursChange={handleBusinessHoursChange} name='sunday-close' value={isChecked.sunday} disabled={checkvalidation.sunday == false} />
          </div>
        </div>
