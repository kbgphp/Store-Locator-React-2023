    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div className='formSection'>
          <div>
            <h3 className='formHeadings'><IoIosBusiness className='d-inline-block titleWicon' /> Business Details</h3>
          ...
          <div>
            <h3 className='formHeadings'><FaInfoCircle className='d-inline-block titleWicon' style={{ marginRight: "5px" }} />Contact Info.</h3>
          ...
          <div>
            <h3 className='formHeadings'><FaInfoCircle className='d-inline-block titleWicon' style={{ marginRight: "5px" }} />Additional Info.</h3>
            <div>
